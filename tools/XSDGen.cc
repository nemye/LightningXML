/// @file XSDGen.cc
/// @brief CLI: lightningxml_xsdgen <schema.xsd> [-o out.hh]
///
/// Reads an XSD, emits LightningXML XmlMetadata to stdout (or -o file), and prints
...
auto main(int argc, char** argv) -> int {
  ...
  for (int i = 1; i < argc; ++i) {
    ...
    if (arg == "-o" && i + 1 < argc) {
      ...
      std::cout << "usage: lightningxml_xsdgen <schema.xsd> [-o out.hh]\n";
      return 0;
    } else if (input.empty()) {
      input = arg;
    }
