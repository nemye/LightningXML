...
struct xml::XmlMetadata<OptItem> {
  static constexpr auto fields =
      std::make_tuple(xml::attrField("id", &OptItem::id), xml::field("title", &OptItem::title),
                      xml::field("desc", &OptItem::desc), xml::field("status", &OptItem::status));
};
...
struct xml::XmlMetadata<OptItemList> {
  static constexpr auto fields = std::make_tuple(xml::vecField("Item", &OptItemList::items));
};
...
struct xml::XmlMetadata<ReqItem> {
  static constexpr auto fields = std::make_tuple(xml::attrField("id", &ReqItem::id, true),
...
struct xml::XmlMetadata<ReqItemList> {
  static constexpr auto fields = std::make_tuple(xml::vecField("Item", &ReqItemList::items, true));
};
...
struct xml::XmlMetadata<NormItem> {
  static constexpr auto fields =
      std::make_tuple(xml::attrField("id", &NormItem::id), xml::field("title", &NormItem::title),
                      xml::field("desc", &NormItem::desc), xml::field("status", &NormItem::status));
};
